...
if (!isset($_SESSION['monster']['init']) || $_SESSION['monster']['init'] == false ) {
    ...
    switch ($dieRoll) {
        case 1:
            ...
            $monsterMaxHp = 8; // Decrease max health for this monster
            break;
        case 2:
            $_SESSION['monster']['monsterName'] = "Nyckelpiga";
            $monsterMaxHp = 15; // Increase max health for this monster
            break;
        case 3:
            $_SESSION['monster']['monsterName'] = "Myra";
            $monsterMaxHp = 18; // Default max health
            break;
        case 4:
            $_SESSION['monster']['monsterName'] = "Skalbagge";
            $monsterMaxHp = 25; // Default max health
            break;
    }
...
if (isset($_POST['explore']) && $playerEnergy >= 1) { // Check if player has energy
    ...
    header("Location: ?page=combat_forest");
    exit();
}
?>
...
<body>
    ...
    <form action="?page=combat_forest" method="post">
    ...
    <form action="?page=combat_forest" method="post">
        ...
        <?php else: ?>
            <input type="button" value="Tillbaka till skogsbrynet" onclick="location.href='?page=forest';">
        <?php endif; ?>
    </form>
